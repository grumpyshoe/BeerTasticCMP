...
import com.grumpyshoe.beertasticcmp.domain.beer.models.Fermentation
import com.grumpyshoe.beertasticcmp.domain.beer.models.Ingredients
import com.grumpyshoe.beertasticcmp.domain.beer.models.IngredientsItem
import com.grumpyshoe.beertasticcmp.domain.beer.models.Method
import com.grumpyshoe.beertasticcmp.domain.beer.models.MethodItem
import com.grumpyshoe.beertasticcmp.domain.beer.models.Value
import com.grumpyshoe.beertasticcmp.domain.beer.models.Volume
...
import com.grumpyshoe.beertasticcmp.domain.beer.utils.mapResult
...
class BeerRepositoryImpl(
    ...
    override suspend fun getBeers(page: Int): ApiResult<List<Beer>> =
        beerRemoteDatasource.getBeers(page = page).mapResult { dtoList ->
    ...
    override suspend fun getBeerById(beerId: Int): ApiResult<Beer> =
        beerRemoteDatasource.getBeerById(beerId).mapResult { beerDto ->
            beerDto?.toBeer()
        }

    override suspend fun checkIfFavorite(beerId: Int): Boolean =
        sharedPreferenceService.checkIfFavorite(beerId)
    ...
    override suspend fun getRandomBeer(): ApiResult<Beer> =
        beerRemoteDatasource.getRandomBeer().mapResult { beerDto ->
            beerDto?.toBeer()
        }
}
    ...
    with(this) {
        try {
            return Beer(
                ...
                imageUrl = "${PunkAPI.BASE_URL}/images/$imageId",
                abv = abv,
                ibu = ibu,
                targetFG = targetFg,
                targetOG = targetOg,
